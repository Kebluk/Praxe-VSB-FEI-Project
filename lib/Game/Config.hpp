...
constexpr int C_BULLET_SPEED_PER_STEP_MIN_MS = 100;
constexpr int C_BULLET_SPEED_PER_STEP_MAX_MS = 300;
...
constexpr int C_SHIELD_HALF_ANGLE = 25;

// Game settings
constexpr int C_HIT_WINDOW_MS = 200;
